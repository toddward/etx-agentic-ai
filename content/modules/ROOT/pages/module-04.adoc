...
[source,bash,options="wrap",role="execute"]
----
List the branches from toddward/etx-agentic-ai repo.
----
+
...
[source,bash,options="wrap",role="execute"]
----
Create a github issue for a fake error in the toddward/etx-agentic-ai repo and assign it to toddward.
----
+
...
[source,bash,options="wrap",role="execute"]
----
Create a github issue using these parameters {"name":"create_issue","arguments":{"owner":"toddward","repo":"etx-agentic-ai","title":"Fake Error: Agentic AI Service Unresponsive","body":"The Agentic AI service is not responding. This is a fake error report."}}} DO NOT add any optional parameters.
----
+
